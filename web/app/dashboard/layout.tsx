...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  const isActive = (target: "home" | "activities" | "reservas" | "checkin" | "perfil") => {
    ...
    if (target === "reservas") return pathname.startsWith("/dashboard/reservas");
    if (target === "checkin") return pathname.startsWith("/dashboard/qr-codes");
    if (target === "perfil") return pathname.startsWith("/dashboard/perfil");
    return false;
  };
